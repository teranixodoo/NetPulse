...
async def _process_state_changes(pool) -> None:
    ...
    Ignoruje NULL prev_alive (první scan).
    """
    try:
        async with pool.acquire() as conn:
